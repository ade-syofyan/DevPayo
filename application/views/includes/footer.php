<footer class="footer">
  ...
  <div class="container-fluid clearfix">
    ...
    <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2020 <a href="#">Payo-App</a>. All rights reserved.</span>

    <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Made With <i class="mdi mdi-heart text-danger"></i> By US (Developers)</span>
