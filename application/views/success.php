          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              <div class="col-lg-6 text-lg-right pr-lg-4">
                <h2 class="display-1 mb-0">SUKSES</h2>
              </div>
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h3>Reset Password!</h3>
                <h3 class="font-weight-light">Kata sandi telah diatur ulang! silakan masuk lagi.</h3>
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-12 mt-xl-2">
                <p class="text-white font-weight-medium text-center">Copyright &copy; Payo-app Team 2020 All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
