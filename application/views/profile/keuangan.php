            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="wrapper d-block d-sm-flex align-items-center justify-content-between">
                        ...
                        <h4 class="card-title mb-0">Profile Keuangan</h4>
                    ...
                    <div class="wrapper">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                                <?= form_open_multipart('profile/ubahkeuangan'); ?>
                                <div class="form-group">
                                    <label>Image Profile</label>
                                    <input type="file" class="dropify" data-max-file-size="1mb" name="image" data-default-file="<?= base_url('images/keuangan/') . $image ?>" />
